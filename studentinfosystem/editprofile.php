      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="course">
              <option value="BTech ECE" <?php echo $course == 'BTech ECE' ? "selected": ""; ?>>BTech ECE</option>
              <option value="BTech CSE" <?php echo $course == 'BTech CSE' ? "selected": ""; ?>>BTech CSE</option>
              <option value="BTech IT" <?php echo $course == 'BTech IT' ? "selected": ""; ?>>BTech IT</option>
              <option value="BTech EEE" <?php echo $course == 'BTech EEE' ? "selected": ""; ?>>BTech EEE</option>
